...
if __name__ == '__main__':
    class ThisUi(wxobject.UI):
        def __init__(self):
            ...
            self.panel1 = None
            self.statictext1_1 = None
            self.statictext1_2 = None
            self.statictext1_3 = None
